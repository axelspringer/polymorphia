package de.bild.backend.polymorphia.legacy;
 ...
 */
public class NoDiscriminatorForPolymorphicLeafClassesTest extends AbstractTest {
    ...
    public void reorderingDocumentTest() {
        Codec<DocumentContainer> documentCollectionCodec = codecRegistry.get(DocumentContainer.class);

        MongoCollection<DocumentContainer> documentMongoCollection = getCollection(DocumentContainer.class);
